...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::interpreter::interpreter_set_source_lang,
            commands::interpreter::interpreter_set_listening,
            commands::translator::translator_set_langs,
            commands::translator::translator_set_listening,
            commands::translator::translator_status,
            commands::conversation::conversation_start,
            commands::conversation::conversation_stop,
            commands::conversation::conversation_status,
            commands::conversation::conversation_reset,
            ...
            commands::plumin_help::ask_plumin,
            ...
            shortcut::change_dictated_emojis_setting,
            shortcut::change_spoken_numerals_setting,
            shortcut::change_numerals_spreadsheet_auto_setting,
            shortcut::change_update_checks_setting,
            shortcut::change_show_whats_new_on_update_setting,
            shortcut::change_voice_engine_setting,
    ...
    let mut builder = tauri::Builder::default()
        ...
        // Única frontera de reproducción del historial. Responde por rangos
        // descifrando como máximo 512 KiB por petición; la webview no obtiene
