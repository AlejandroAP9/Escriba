...
#[tauri::command]
#[specta::specta]
pub fn change_review_before_paste_setting(app: AppHandle, on: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.review_before_paste = on;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_high_contrast_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
...
#[tauri::command]
#[specta::specta]
pub fn change_colorblind_assist_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.colorblind_assist = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
#[tauri::command]
#[specta::specta]
pub fn change_calm_mode_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.calm_mode = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
...
pub fn update_text_replacements(
    app: AppHandle,
    rules: Vec<settings::TextReplacement>,
) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.text_replacements = rules;
    settings::write_settings(&app, settings);
    Ok(())
}
...
pub fn change_pause_media_on_dictate_setting(app: AppHandle, enabled: bool) -> Result<(), String> {
    let mut settings = settings::get_settings(&app);
    settings.pause_media_on_dictate = enabled;
    settings::write_settings(&app, settings);
    Ok(())
}
