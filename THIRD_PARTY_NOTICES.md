...
| **Mapa de tildes** (`resources/es/tildes.tsv.gz`)              | Restaurar tildes inequívocas en el dictado en español | Derivado del diccionario **RLA-ES** vía [LibreOffice/dictionaries](https://github.com/LibreOffice/dictionaries/tree/master/es), usado bajo **MPL 1.1** (tri-licencia GPLv3/LGPLv3/MPL 1.1). No se redistribuye el diccionario: solo el mapa derivado de pares sin-tilde → con-tilde, generado por `scripts/gen-tildes.ts` (los SHA-256 de los archivos fuente quedan en la cabecera del mapa) |
